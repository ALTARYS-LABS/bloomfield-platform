...
| 5 | STORY-005 | User Module — Frontend Login & Protected Routes | STORY-004 | M | 🔲 Not started |
| 6 | STORY-006 | Portfolio Module (Positions, Real-Time Valuation, P&L) | STORY-003, STORY-004 | M | 🔲 Not started |
...
| V004 | STORY-006 | `seed_demo_portfolio` (dev seed, optional profile) |
| V005 | STORY-007 | `alerts_module` (alert_rules, alert_events) |
| V006 | STORY-008 | `ohlcv_hypertable` (TimescaleDB extension + ohlcv + continuous aggregates) |
...
| STORY-005 | ~300 | Auth context + login page + route guards |
