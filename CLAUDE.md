...
5. Prefer records over classes for controllers, config classes, and any stateless/immutable Spring beans (Java 25 best practice). Only use classes when mutable state is required.
